...
<tr>
    ...
    <td valign='top' class='dataField'>
    	<input type="text" value="{$dashlet_title}" size="30" name="myleadschart_dashlet_title"/>
    </td>
</tr>
...
<tr>
    ...
    <td valign='top' class='dataField'>
    	<input onblur="parseDate(this, '{$cal_dateformat}');" class="text" name="myleadschart_date_start" size='12' maxlength='10' id='date_start' value='{$date_start}'>
...
<tr>
    ...
    <td valign='top' class='dataField'>
    	<input onblur="parseDate(this, '{$cal_dateformat}');" class="text" name="myleadschart_date_end" size='12' maxlength='10' id='date_end' value='{$date_end}'>
    	<img src="themes/default/images/jscalendar.gif" alt="{$LBL_ENTER_DATE}" id="date_end_trigger" align="absmiddle">
    </td>
</tr>

    <tr>
    <td valign='top' class='dataLabel' nowrap>{$LBL_LEAD_STATUS}</td>
    <td valign='top' class='dataField'>
    	<select name="myleadschart_status[]" multiple size='3'>
    		{$selected_datax}
    	</select></td>
    </tr>
